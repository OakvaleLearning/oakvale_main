...
const FAQ_SECTIONS: { title: string; items: { q: string; a: string }[] }[] = [
  {
    ...
    items: [
      ...
      { q: 'What is the Health Innovation Challenge?', a: 'The Health Innovation Challenge is the capstone competition at the heart of the programme. In Week 3, your team of two receives a real, unsolved healthcare challenge relevant to your track. You develop a solution over one week and pitch it live to an independent panel of industry judges on 5 October, 2026. There are 18 teams across the programme and a total prize pool of ₦4,000,000.' },
      ...
      { q: 'Will this affect my university studies?', a: 'The programme runs from August to October 2026. Plan for around five to seven hours per week. Think about whether that fits around any rotations or assessments you have before applying.' },
    ],
  },
  {
    title: 'Who can apply?',
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What is the Health Innovation Challenge brief?', a: 'In Week 3, your team of two receives a real, unsolved problem relevant to your track. You have one week to develop your solution. By Friday 2 October your team submits a structured pitch deck. On Monday 5 October you deliver a live five-minute pitch to the independent judging panel via Zoom.' },
    ],
  },
  {
