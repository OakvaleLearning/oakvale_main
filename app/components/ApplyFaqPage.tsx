...
const FAQ_SECTIONS: { title: string; items: { q: string; a: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      { q: 'Can I get help with the fee?', a: 'Yes. Fifteen scholarship and financial aid places are available across the programme, five per institution. The application form includes a dedicated financial aid section. Options include a full scholarship (fee completely waived) or flexible payment (fee split into two instalments). Applying for financial aid does not affect how the rest of your application is assessed.' },
      ...
      { q: 'What if I am awarded a scholarship?', a: 'If your scholarship application is approved, you will be notified in your acceptance message. Full scholarship recipients do not need to make any payment. Flexible payment recipients will receive two payment deadlines, each covering half the fee.' },
